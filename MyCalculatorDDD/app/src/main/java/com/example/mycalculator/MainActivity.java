...
public class MainActivity extends AppCompatActivity {
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        edit=previousCalculation.getText().toString();
        result=display.getText().toString();

        savedInstanceState.putString("Input from Edit", edit);
        savedInstanceState.putString("Input from res", result);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        edit = savedInstanceState.getString("Input from Edit");
        result = savedInstanceState.getString("Input from res");

        previousCalculation.setText(edit);
